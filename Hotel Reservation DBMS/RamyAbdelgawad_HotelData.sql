...
INSERT INTO roomAmenity (roomID, amenityID) VALUES
	(1, 1),(1, 2),(2, 3),(3, 1),(3, 2),(4, 3),(5, 1),(5, 3),(5, 2),
	(6, 1),(6, 3),(7, 1),(7, 3),(7, 2),(8, 1),(8, 3),(9, 1),(9, 2),
	(10, 3),(11, 1),(11, 2),(12, 3),(13, 1),(13, 3),(13, 2),(14, 1),
	(14, 3),(15, 1),(15, 3),(15, 2),(16, 1),(16, 3),(17, 1),(17, 3),
	(17, 4),(18, 1),(18, 3), (18, 4);
...
INSERT INTO Guest (name, address, city, state, zip, phone) VALUES
	('Ramy Abdelgawad',	'21 Wall St.',	'Huntington', 'NY', '11743', '(123) 456-7899'),
...
INSERT INTO reservation (name, adults, children, start_date, end_date, total_room_cost, roomId, guestId) VALUES 
	...
	('Ramy Abdelgawad', 1, 1, '2023-3-17', '2023-3-20', 524.97, 15, 1),
	...
	('Ramy Abdelgawad', 2, 0, '2023-6-28', '2023-7-2', 699.96, 5, 1),
